...
if [ -z $SP_APP_ID ] || [ -z $SP_APP_KEY ] || [ -z $SP_TENANT_ID ] ; then
  ...
  echo "--> Attempting to log in to Azure with service principal ${SP_NAME}"
